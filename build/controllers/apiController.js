...
exports.postTodo = exports.getTodo = exports.deleteTodo = void 0;
var _Todos = _interopRequireDefault(require("../models/Todos.js"));
...
var getTodo = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _context.next = 8;
          return _Todos["default"].findById(user.todoList);
        case 8:
          todo = _context.sent;
          if (!todo) {
            _context.next = 11;
  ...
  return function getTodo(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.getTodo = getTodo;
var postTodo = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var todo, _id, user, updateTodo, filter, update, doc, newTodo;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 12:
          ...
          _context2.next = 17;
          return _Todos["default"].findOneAndUpdate(filter, update, {
            "new": true
          });
        case 17:
          doc = _context2.sent;
  ...
  return function postTodo(_x3, _x4) {
...
var deleteTodo = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var text, _id, user, todoList, filter, newTodo, update, doc;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 8:
          ...
          newTodo = todoList.todo.filter(function (word) {
            return word !== text;
          });
          update = {
            todo: newTodo
        ...
        case 15:
          ...
          return doc.save();
        case 18:
          return _context3.abrupt("return", res.sendStatus(201));
        case 19:
